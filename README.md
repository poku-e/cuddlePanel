...
- System administration for host users, account profile edits, password and lifecycle controls, sudo group membership, host-account deletion, constrained `chown` / `chmod`, and `authorized_keys`
